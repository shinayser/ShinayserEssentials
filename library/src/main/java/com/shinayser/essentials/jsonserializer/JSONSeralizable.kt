			...
			field?.let {
				...
				try {
					...
					when {
						...
						field.type == Long::class.javaObjectType || field.type == Long::class.java
						-> field.set(this, json.getLong(key))

						field.type == Int::class.javaObjectType || field.type == Int::class.java ||
								field.type == Short::class.javaObjectType || field.type == Short::class.java
						-> field.set(this, json.getInt(key))

						field.type == Float::class.javaObjectType || field.type == Float::class.java
						-> field.set(this, json.getDouble(key))

						field.type == Double::class.javaObjectType || field.type == Double::class.java
						-> field.set(this, json.getDouble(key))

						field.type == String::class.javaObjectType || field.type == String::class.java
						-> field.set(this, json.getString(key))

						field.type == Char::class.javaObjectType || field.type == Char::class.java
						-> field.set(this, json.getString(key)[0])

						field.type == Boolean::class.javaObjectType || field.type == Boolean::class.java
						-> {
