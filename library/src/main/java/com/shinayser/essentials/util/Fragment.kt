 ...
 */
//Delegates
fun Fragment.extraString(key: String) = lazy { arguments!!.getString(key)!! }

fun Fragment.extraBoolean(key: String) = lazy { arguments!!.getBoolean(key)!! }
fun Fragment.extraDouble(key: String) = lazy {arguments?.getDouble(key)!!}
fun Fragment.extraLong(key: String) = lazy {arguments?.getLong(key)!!}
fun Fragment.extraInt(key: String) = lazy {arguments?.getInt(key)!!}
